...
def test_list_all(database):
    ...
    # assert str(check) == [('Igor', 'Wise', '16620315 9220', '1-535-484-7619', '2020-01-15 04:05:37', 'Asset Management'), ('Addison', 'Hurley', '16910913 6391', '1-913-830-6195', '2019-12-24 11:30:44', 'Tech Support'), 
